# -*- coding: utf-8 -*-
"""
Created on Thu Feb 14 21:09:25 2019
...
if __name__ == '__main__':
    ...
    for f in [draw_b, draw_e, draw_t, draw_t, draw_a, draw_, \
              draw_b, draw_i, draw_a, draw_n, draw_c, draw_a, draw_, \
              draw_b, draw_u, draw_b, draw_i]:
        f(bob, size)
        skip(bob, size)
